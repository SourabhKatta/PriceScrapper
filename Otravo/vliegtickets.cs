    ...
    public class vliegtickets
    {
        ...
        private void GetPrice(string bookingEngine, IWebDriver driver, WebDriverWait wait, IJavaScriptExecutor js, IReadOnlyCollection<IWebElement> count, StreamWriter sw)
        {
            try
            {
                ...
                js.ExecuteScript("document.getElementById('departureDate1_hidden').value='" + fromDate + "'");
                js.ExecuteScript("document.getElementById('departureDate2_hidden').value='" + toDate + "'");
